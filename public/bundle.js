...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RandomBars = __webpack_require__(230);
	
	var _RandomBars2 = _interopRequireDefault(_RandomBars);
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'li',
	        null,
	        _react2.default.createElement(_RandomLink2.default, null)
	      )
	    ),
	    props.children
	  );
	...
	var _RandomLink = __webpack_require__(227);
	
	var _RandomLink2 = _interopRequireDefault(_RandomLink);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewBarsHi = __webpack_require__(229);
	
	var _NewBarsHi2 = _interopRequireDefault(_NewBarsHi);
	...
	function Home() {
	  ...
	  var data = Array(5).fill(1).map(function () {
	    return randomNum();
	  });
	
	  return _react2.default.createElement(_NewBarsHi2.default, { data: data });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewBarsHi = function (_Component) {
	  _inherits(NewBarsHi, _Component);
	
	  function NewBarsHi(props) {
	    _classCallCheck(this, NewBarsHi);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(NewBarsHi).call(this, props));
	
	    _this.Highcharts = function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function RandomBars(props) {
	  var count = props.params.barCount;
	  var minHeight = props.params.minHeight;
	  var maxHeight = props.params.maxHeight;
	  var randomNum = function randomNum() {
	    return Math.abs(Math.round(Math.random() * (maxHeight - minHeight)) + +minHeight);
	  };
	  var data = Array(+count).fill(1).map(function () {
	    return randomNum();
	  });
